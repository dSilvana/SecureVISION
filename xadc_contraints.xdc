...
##LEDs
set_property -dict {PACKAGE_PIN M14 IOSTANDARD LVCMOS18} [get_ports alarm_over]
set_property -dict {PACKAGE_PIN M15 IOSTANDARD LVCMOS18} [get_ports alarm_under]
...
##Pmod Header JA (XADC)
set_property -dict { PACKAGE_PIN N15   IOSTANDARD LVCMOS18 } [get_ports { vauxp0 }]; #IO_L21P_T3_DQS_AD14P_35 Sch=JA1_R_p
...
set_property -dict { PACKAGE_PIN N16   IOSTANDARD LVCMOS18 } [get_ports { vauxn0 }]; #IO_L21N_T3_DQS_AD14N_35 Sch=JA1_R_N
...
set_property MARK_DEBUG true [get_nets {normal_voltage[11]_i_1_n_0}]
set_property MARK_DEBUG true [get_nets drdy_out]
set_property MARK_DEBUG true [get_nets {do_out[5]}]
set_property MARK_DEBUG true [get_nets {do_out[6]}]
set_property MARK_DEBUG true [get_nets {do_out[9]}]
set_property MARK_DEBUG true [get_nets {do_out[11]}]
set_property MARK_DEBUG true [get_nets {do_out[14]}]
set_property MARK_DEBUG true [get_nets {do_out[15]}]
set_property MARK_DEBUG true [get_nets {do_out[4]}]
set_property MARK_DEBUG true [get_nets {do_out[7]}]
set_property MARK_DEBUG true [get_nets {do_out[8]}]
set_property MARK_DEBUG true [get_nets {do_out[10]}]
set_property MARK_DEBUG true [get_nets {do_out[12]}]
set_property MARK_DEBUG true [get_nets {do_out[13]}]
set_property MARK_DEBUG false [get_nets xadc_instance/drdy_out]
set_property MARK_DEBUG false [get_nets {xadc_instance/do_out[3]}]
set_property MARK_DEBUG false [get_nets {xadc_instance/do_out[4]}]
set_property MARK_DEBUG false [get_nets {xadc_instance/do_out[5]}]
set_property MARK_DEBUG false [get_nets {xadc_instance/do_out[7]}]
set_property MARK_DEBUG false [get_nets {xadc_instance/do_out[12]}]
set_property MARK_DEBUG false [get_nets {xadc_instance/do_out[13]}]
set_property MARK_DEBUG false [get_nets {xadc_instance/do_out[1]}]
set_property MARK_DEBUG false [get_nets {xadc_instance/do_out[8]}]
set_property MARK_DEBUG false [get_nets {xadc_instance/do_out[9]}]
set_property MARK_DEBUG false [get_nets {xadc_instance/do_out[14]}]
set_property MARK_DEBUG false [get_nets {xadc_instance/do_out[0]}]
set_property MARK_DEBUG false [get_nets {xadc_instance/do_out[6]}]
set_property MARK_DEBUG false [get_nets {xadc_instance/do_out[10]}]
set_property MARK_DEBUG false [get_nets {xadc_instance/do_out[2]}]
set_property MARK_DEBUG false [get_nets {xadc_instance/do_out[11]}]
set_property MARK_DEBUG false [get_nets {xadc_instance/do_out[15]}]
connect_debug_port u_ila_0/clk [get_nets [list clk_IBUF_BUFG]]
connect_debug_port u_ila_0/probe1 [get_nets [list {do_out[4]} {do_out[5]} {do_out[6]} {do_out[7]} {do_out[8]} {do_out[9]} {do_out[10]} {do_out[11]} {do_out[12]} {do_out[13]} {do_out[14]} {do_out[15]}]]
connect_debug_port u_ila_0/probe2 [get_nets [list drdy_out]]
connect_debug_port u_ila_0/probe3 [get_nets [list {normal_voltage[11]_i_1_n_0}]]
...
connect_debug_port u_ila_0/probe0 [get_nets [list {do_out[0]} {do_out[1]} {do_out[2]} {do_out[3]} {do_out[4]} {do_out[5]} {do_out[6]} {do_out[7]} {do_out[8]} {do_out[9]} {do_out[10]} {do_out[11]} {do_out[12]} {do_out[13]} {do_out[14]} {do_out[15]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe1]
set_property port_width 12 [get_debug_ports u_ila_0/probe1]
connect_debug_port u_ila_0/probe1 [get_nets [list {normal_voltage[0]} {normal_voltage[1]} {normal_voltage[2]} {normal_voltage[3]} {normal_voltage[4]} {normal_voltage[5]} {normal_voltage[6]} {normal_voltage[7]} {normal_voltage[8]} {normal_voltage[9]} {normal_voltage[10]} {normal_voltage[11]}]]
create_debug_port u_ila_0 probe
