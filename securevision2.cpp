...
// Framebuffer output helper
// Writes annotated frames directly to /dev/fb0 so no cv::imshow() is needed
...
int main()
{
    ...
    const string modelPath = "/run/media/mmcblk0p2/home/root/securevision/best.onnx";
