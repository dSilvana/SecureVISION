...
#set_property -dict { PACKAGE_PIN P15   IOSTANDARD LVCMOS33 } [get_ports { clk_enable }]; #IO_L24P_T3_34 Sch=sw[1]
#set_property -dict { PACKAGE_PIN W13   IOSTANDARD LVCMOS33 } [get_ports { start }]; #IO_L4N_T0_34 Sch=sw[2]
...
##LEDs
set_property -dict { PACKAGE_PIN M14   IOSTANDARD LVCMOS33 } [get_ports { person_detected_0 }]; #IO_L23P_T3_35 Sch=led[0]
set_property -dict { PACKAGE_PIN M15   IOSTANDARD LVCMOS33 } [get_ports { volt_fail_0 }]; #IO_L23N_T3_35 Sch=led[1] --Glitch Detected
set_property -dict { PACKAGE_PIN G14   IOSTANDARD LVCMOS33 } [get_ports { app_auth_fail_0 }]; #IO_0_35 Sch=led[2]
#set_property -dict { PACKAGE_PIN D18   IOSTANDARD LVCMOS33 } [get_ports { bitstream_auth_fail }]; #IO_L3N_T0_DQS_AD1N_35 Sch=led[3]
...
##Pmod Header JC                                                                                                                  
#set_property -dict { PACKAGE_PIN V15   IOSTANDARD LVCMOS33     } [get_ports { uart_txd }]; #IO_L10P_T1_34 Sch=jc_p[1]   			 
...
# TRNG ring oscillator constraints
#--------------------------------------------------------
#Preserve ring oscillator LUTs
set_property DONT_TOUCH true [get_cells -hier -filter {NAME =~ *inst_TRNGMaskGen*gen_ringosc[*].gen_inverters[*].LUT6_NOT_inst}]
set_property DONT_TOUCH true [get_cells -hier -filter {NAME =~ *inst_TRNGMaskGen*gen_ringosc[*].LUT6_AND_inst}]
set_disable_timing [get_cells -hier -filter {NAME =~ *inst_TRNGMaskGen*gen_ringosc[*].LUT6_AND_inst}]
#set_property DONT_TOUCH true [get_cells -hier -filter {NAME =~ *gen_ringosc[*].gen_inverters[*].LUT6_NOT_inst}]
#set_property DONT_TOUCH true [get_cells -hier -filter {NAME =~ *gen_ringosc[*].LUT6_AND_inst}]

##Break combinational loop for static timing analysis
#set_disable_timing [get_cells -hier -filter {NAME =~ *gen_ringosc[*].LUT6_AND_inst}]

#Allow intentional combinational loops for all 16 rings
set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets -hier -filter {NAME =~ *inst_TRNGMaskGen*node*}]
set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets -hier -filter {NAME =~ *inst_TRNGMaskGen*LUT6_AND_inst_n_0*}]
